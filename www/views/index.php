	...
	<div class="row" id="content">
		...
		<div class="con3 banner col-xs-4">
			...
			<div class="banner2 roll-banner">
				<a href="#none" class="eq-01" style="background-image: url(<?php echo $config["resourcesDir"]; ?>/images/main/banner2-1.png)">
					<span class="sr-only">간편서비스 이메일상담 신청하기</span>
					<span href="#none" class="btn-join">바로가기</span>
				</a>
				<a href="#none" class="eq-01" style="background-image: url(<?php echo $config["resourcesDir"]; ?>/images/main/banner2-1.png)">
					<span class="sr-only">간편서비스 이메일상담 신청하기</span>
					<span href="#none" class="btn-join">바로가기</span>
