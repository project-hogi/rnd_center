        ...
        <form action="">
          <fieldset>
            ...
            <caption class="tar"><span class="hot-point">*</span>표시는 필수항목입니다. 반드시 기입해주세요</caption>
              ...
              <tbody>
                <tr>
                  <th><label for="">회원구분</label><span class="hot-point">*</span></th>
            ...
            <table class="table table-form">
              ...
              <tbody>
                ...
                <tr>
                  <th><label for="join-form-2-03">휴대폰번호</label><span class="hot-point">*</span></th>
                ...
                <tr>
                  <th><label for="join-form-2-04">이메일</label><span class="hot-point">*</span></th>
              ...
              <tbody>
                <tr>
                  <th><label for="join-form-2-01">성명 (담당자2)</label><span class="hot-point">*</span></th>
                  <td><input type="text" id="join-form-2-01" class="form form-lg"></td>
                </tr>
                <tr>
                  <th><label for="join-form-2-02">전화번호</label><span class="hot-point">*</span></th>
