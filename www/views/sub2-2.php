      ...
      <div class="sub-content">
        <form action="">
          <fieldset>
            ...
            <caption class="tar"><span class="alert">*</span>표시는 필수항목입니다. 반드시 기입해주세요</caption>
              <col width="167" />
              <col />
              <tbody>
                <tr>
                  <th><label for="">회원구분</label><span class="alert">*</span></th>
                  <td><label for="join-form-00">멘토</label>
                    <input type="radio" id="join-form-00" name="join-form-00">
                    <label for="join-form-001" class="ml20">전문가</label>
                    <input type="radio" id="join-form-001" name="join-form-00" class="">
                    <label for="join-form-002" class="ml20">회계법인</label>
                    <input type="radio" id="join-form-002" name="join-form-00" class=""></td>
                </tr>
                <tr>
                  <th><label for="join-form-1-01">회원아이디</label><span class="alert">*</span></th>
                ...
                <tr>
                  <th><label for="join-form-1-02">비밀번호</label><span class="alert">*</span></th>
                ...
                <tr>
                  <th><label for="join-form-1-03">비밀번호 확인</label><span class="alert">*</span></th>
                  <td><input type="password" id="join-form-1-03" class="form form-lg"></td>
                </tr>
                <tr>
                  <th><label for="join-form-1-04">회사/소속명</label><span class="alert">*</span></th>
                  <td><input type="text" id="join-form-1-04" class="form form-xl"></td>
                </tr>
                <tr>
                  <th><label for="join-form-1-05">사업자등록번호</label><span class="alert">*</span></th>
                  <td>
                  	<input type="text" id="join-form-1-05" class="form form-xl">
                  	<a class="btn btn-default custom-button1">중복확인</a>
                  	<span class="point-explain">* (- 없이 숫자만 입력)</span>
                  </td>
                </tr>
                <tr>
                  <th><label for="join-form-1-06">대표자명</label><span class="alert">*</span></th>
                  <td><input type="text" id="join-form-1-06" class="form form-xl"></td>
                </tr>
                <tr>
                  <th><label for="join-form-1-07">전화번호</label><span class="alert">*</span></th>
                ...
                <tr>
                  <th><label for="join-form-1-08">팩스번호</label><span class="alert">*</span></th>
                ...
                <tr>
                  <th rowspan="3"><label for="join-form-1-9">주소</label><span class="alert">*</span></th>
                  <td>
            ...
            <table class="table table-form">
              ...
              <tbody>
                <tr>
                  <th><label for="join-form-2-01">성명 (담당자1)</label><span class="alert">*</span></th>
                  <td><input type="text" id="join-form-2-01" class="form form-lg"></td>
                </tr>
                <tr>
                  <th><label for="join-form-2-02">전화번호</label><span class="alert">*</span></th>
                ...
                <tr>
                  <th><label for="join-form-2-03">휴대폰번호</label><span class="alert">*</span></th>
                  <td><select name="join-form-2-03" id="join-form-2-03" class="select form-xs select-type1">
                ...
                <tr>
                  <th><label for="join-form-2-04">이메일</label><span class="alert">*</span></th>
                  <td><input type="text" id="join-form-2-04" class="form form-md">
                    <span class="form-space">@</span>
              ...
              <tbody>
                <tr>
                  <th><label for="join-form-2-01">성명 (담당자2)</label><span class="alert">*</span></th>
                  <td><input type="text" id="join-form-2-01" class="form form-lg"></td>
                </tr>
                <tr>
                  <th><label for="join-form-2-02">전화번호</label><span class="alert">*</span></th>
